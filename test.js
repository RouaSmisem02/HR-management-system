...
Employee.prototype.render = function () {
    ...
    nameEl.textContent = employeeArr[i].fullName;
...
function addNewEmployeeHandler(event) {
    ...
    //console.log("this is the item as josn from local storage: ", localStorage.getItem("jsonEmployee"))
    //localStorage.setItem("addNewEmployee", newEmployee)
    //console.log(localStorage.getItem("addNewEmployee"))
    newEmployee.render();
}
